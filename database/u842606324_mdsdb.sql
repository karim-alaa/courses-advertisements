...
INSERT INTO `events` (`id`, `doctor_id`, `course_id`, `address_id`, `active`, `price`, `address_details`, `name`, `small_image`, `big_image`, `slide_visible`, `home_visible`, `capacity`, `short_disc`, `date`, `page_link`, `deleted_at`, `created_at`, `updated_at`) VALUES
(31, 13, 25, 1, 1, 'dfdsffs', 'dffsfd', 'ESSthhdfhgfghf', 'images/courses/28961242018-05-14-ESSthhdfhgfghf.png', 'images/courses/18614862018-05-14-ESSthhdfhgfghf.png', 1, 1, 50, 'srfrgffvaffcgsgdvf', '2018-05-22', 'http://master-dental-society-s-school.thinkific.com/courses/st-course', NULL, '2018-05-04 16:15:18', '2018-05-14 15:52:49');
...
(5, 'karim alaa', 'admin3@yahoo.com', '$2y$10$JgxOdR1n1qgtB0OBw3gxFOhVolryE8dSUBNy3rZWH/i/.V7yAuUDa', 2, 1, 1, 'title', NULL, '02201405231', NULL, 'hbZxChyG3xBoPu2ZHdfwYDICz56vbKxscBcL0VgEG2mQeYHFexaRZNAYlG06', '2017-12-11 08:53:48', '2017-12-11 08:53:48'),
(31, 'karim alaa', 'doctor@yahoo.com', '$2y$10$g06WU0XG6LhteZ/itdxfHOgbjlC6H2NUYQlnmHVlVIMwfXGSJfz.K', 3, 1, 1, NULL, NULL, '01141442423', NULL, NULL, '2018-04-21 17:27:14', '2018-04-21 17:27:14'),
...
--
-- AUTO_INCREMENT for table `f_q_s`
--
ALTER TABLE `f_q_s`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
